...
get_ipython().system(' ls ./unzipped_data')
...
age_gender_bkts = pd.read_csv('unzipped_data/age_gender_bkts.csv')
...
countries = pd.read_csv('unzipped_data/countries.csv')
...
sample_submission_NDF = pd.read_csv('unzipped_data/sample_submission_NDF.csv')
...
sessions = pd.read_csv('unzipped_data/sessions.csv')
...
train_users_2 = pd.read_csv('unzipped_data/train_users_2.csv')
